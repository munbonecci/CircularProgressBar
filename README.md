...
<p align="center">
This app was created to learn more about Android compose using the CircularProgressBar component created with Canvas.
</p>
...
```bash
git clone https://github.com/munbonecci/CircularProgressBar.git
```
